...
We will use exactly the same **department-service** and **employee-service** as in the [last tutorial](https://github.com/Meziano/ms-tutorial-003).
### The configuration files
...
spring.cloud.config.url=http://localhost:8888
``` 
We can see that the communication is still working by requisting http://localhost:8081/departments/with-employees/3
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNDM2MDUwODc3LC0xNjcyNTIxOTkzLC0yMD
Q5NDQxNzQwLDE3NjY4ODA5NDIsLTEzMjI5NzczNDEsMTM3ODMx
MTE3LDEwNzY2MTM1MjcsNDExNDk0OTU3LDEyODkyNzUwMjMsMT
IyMjc4MzM3NywtNjA5MzU2NjgxLC0zNDM0MDc3OTYsOTUwODE1
NzMyLDM5MTU1MDU1LDE2NDI0MzMzODEsLTE4NjAwODQ0NDEsMT

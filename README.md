...
```
 ...
 ![Config Data from local repository for employee-service for dev profile](images/LiveRefreshOfConfigDataForEmployeeserviceDev?raw=true)
...
### Summary
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTk2NDEyMTk3NywxODg3Mzk5MzgzLDY3Nz
